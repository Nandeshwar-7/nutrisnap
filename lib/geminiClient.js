...
2. If it does, respond ONLY in JSON with EXACT keys and types:
   {
     "isFood": true,
     "foodName": "<string>",
     "estimatedCalories": "<string, calories per serving>",
...
Rules:
- Output must be valid JSON with no extra text or commentary.
- If unsure, provide best estimate based on common nutrition databases.`;
